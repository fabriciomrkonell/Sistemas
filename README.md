...
<h2>D</h2>Dependency Inversion - Inverção de dependência - Se depender de alguem, depdenda de alguem abstrato, pois ao contrario podem sofrer alterações classes de alto nivel não podemdepender de classes de baixo nivel, a não ser de abstração
